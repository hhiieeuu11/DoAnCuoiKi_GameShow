...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void AxVideoChatServer1_ClientConnected_1(object sender, AxVideoChatServerLib._DVideoChatServerEvents_ClientConnectedEvent e)
        {
            string strUserID;
            string strListID;
        ...
        private void AxVideoChatServer1_ClientDisconnected_1(object sender, AxVideoChatServerLib._DVideoChatServerEvents_ClientDisconnectedEvent e)
        {
            string strUserID;
            string strListID;
            strUserID = e.iUserID.ToString();
